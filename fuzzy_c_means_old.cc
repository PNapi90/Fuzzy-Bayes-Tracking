...
fuzzy_c_means::fuzzy_c_means(double fuzz,int verbosity){
...
void fuzzy_c_means::fuzzy_clustering(double** data,int len){
    sum_edep = 0;
    if(len == 1){
        am_clusters = 1;
        am_points = 1;
...
int fuzzy_c_means::return_am_clusters(){return am_clusters;}
